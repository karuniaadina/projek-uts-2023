        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              ...
              <p>Untuk menjaga keamanan produk maka harap konfirmasi jika ada kesalahan pada toko</p>
            </div>
            <div class="page_link">
    ...
    <section class="tracking_box_area section_gap">
        <div class="container">
            <div class="tracking_box_inner">
                <p>Untuk melacak pesanan Anda, silakan masukkan ID Pesanan Anda di kotak di bawah ini dan tekan tombol "Lacak". Ini diberikan
                  kepada Anda pada tanda terima dan email konfirmasi yang seharusnya Anda terima.</p>
