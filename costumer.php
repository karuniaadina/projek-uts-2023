...
<head>
  ...
  <title>Karunia kitchenset | Costumer </title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="#" class="nav-link">Costumer</a>
    </li>
  </ul>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="img/blog/logo_kk.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="halamanadmin.php" class="brand-link">
    <img src="img/blog/logo_kk.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
      <span class="brand-text font-weight-light">Kkitchenset</span>
    </a>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Costumer </h3>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>L</td>
                      <td>081900120034</td>
                      <td> dudeerlangga@gmail.com</td>
                      <td>Depok</td>
                      <td>2</td>
                    </tr>                    
                    <tr>
                      <td>4</td>
                      <td>Amalia Hasanah</td>
                      <td>P</td>
                      <td>081318387621</td>
                      <td> lia.hasanah@gmail.com</td>
                      <td>Bogor</td>
                      <td>3</td>
                    </tr>
                  </tbody>
